      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="inline-flex flex-col items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-text-muted tracking-[0.3em] uppercase mt-0.5">BEEPYRED ISP Group</p>
            </div>
          </div>
        </div>
        ...
        >
          <div>
            ...
            <p className="text-xs text-text-muted mt-0.5">Panel de analítica del asistente</p>
          </div>
        ...
        <p className="text-center text-[10px] text-text-muted/40 mt-5 tracking-widest uppercase">
          Acceso restringido · © 2026 BEEPYRED
        </p>
      </div>
    </div>
  )
